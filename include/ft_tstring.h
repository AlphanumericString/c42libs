...
bool		ft_string_append(t_string *str, const char *src);
/// @brief append at most n chars of the string src to the string str
/// @param str t_string to modify
/// @param src string to append
/// @param n number of chars to append
/// @return true if the string has been appended otherwise false
bool		ft_string_append_n(t_string *str, const char *src,
				size_t n);
...
/// @param src string to append
/// @return true if the string has been appended otherwise false
bool		ft_string_append_s(t_string *str,
				const t_string *src);
/// @brief append at most n chars of the string src to the string str
/// @param str t_string to modify
/// @param src string to append
/// @param n number of chars to append
/// @return true if the string has been appended otherwise false
bool		ft_string_append_s_n(t_string *str,
				const t_string *src, size_t n);
...
bool		ft_string_insert(t_string *str, const char *src,
				size_t pos);
...
/// @return true if the string has been inserted otherwise false
bool		ft_string_insert_n(t_string *str, const char *src,
				size_t pos, size_t n);
...
/// @param pos position to insert the string
/// @return true if the string has been inserted otherwise false
bool		ft_string_insert_s(t_string *str, const t_string *src,
				size_t pos);
/// @brief insert at most n chars of the string src in the string str at the
/// specified position
/// @param str t_string to modify
...
t_string	*ft_string_substr(const t_string *str,
...
int			ft_string_cmp(const t_string *str,
				const char *cmp);
...
/// @return 0 if the strings are identical, otherwise the difference between the
/// first different char (s1 - s2)
int			ft_string_ncmp(const t_string *str,
				const char *cmp, size_t n);
/// @brief compare the string with the string cmp
/// @param str t_string to compare
/// @param cmp string to compare
/// @return 0 if the strings are identical, otherwise the difference between the
/// first different char (s1 - s2)
int			ft_string_cmpstr(const t_string *str,
				const t_string *cmp);
/// @brief compare the string with the string cmp up to n chars
/// @param str t_string to compare
/// @param cmp string to compare
...
/// @return 0 if the strings are identical, otherwise the difference between the
/// first different char (s1 - s2)
int			ft_string_ncmpstr(const t_string *str,
				const t_string *cmp, size_t n);
...
bool		ft_string_set(t_string *str, const char *src);
...
/// -> "123"
/// @return true if the string has been set otherwise false
bool		ft_string_set_n(t_string *str,
...
bool		ft_string_set_inplace(t_string *str, char *src);
...
bool		ft_string_rpl(t_string *str,
...
/// @param replace_by string to replace with
/// @return true if the string has been replaced otherwise false
bool		ft_string_rpl_chr(t_string *str, char to_replace,
				char replace_by);
