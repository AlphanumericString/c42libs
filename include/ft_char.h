...
/// @brief check if the char is an octal digit
/// @param c char to check
/// @return 1 if the char is an octal digit, 0 otherwise
int		ft_isoctdigit(int c);

/// @brief check if the char is a hexadecimal digit
/// @param c char to check
/// @return 1 if the char is a hexadecimal digit, 0 otherwise
