...
/*   Updated: 2023/12/12 12:41:55 by bgoulard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// @brief Clear a vector by setting its size to 0
/// @param vec pointer to the vector
/// @return void
...
/// @brief Create a new vector from an array and free the array
/// @param data data to add to the vector
/// @param count count of the data
/// @return pointer to the new vector
...
/// @return true if the vector was reserved, false otherwise
