...
/*   Updated: 2026/03/11 01:41:08 by bgoulard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	static t_mod_constructor	tests[] = {tests_args, tests_bitset,
		tests_lists, tests_map, tests_math, tests_optional, tests_pair,
		tests_string, tests_vector,
		NULL};
