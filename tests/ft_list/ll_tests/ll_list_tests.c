...
int	tests_linked_list_all(void)
{
	...
	{"create", t_ll_create}, {"copy_node", t_ll_copy_node}, \
	{"copy_list", t_ll_copy_list},	{"delone", t_ll_delone}, \
	{"delete_range", t_ll_delete_range}, {"delete", t_ll_delete}, \
	{"find", t_ll_find}, \
	...
	{"size_match", t_ll_size_match}, {"subrange", t_ll_subrange}, \
	{NULL, NULL}
	};
