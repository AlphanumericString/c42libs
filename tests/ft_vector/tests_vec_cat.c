...
/*   Updated: 2024/05/24 12:56:31 by bgoulard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	test_vec_cat(void)
{
	...
	if (ret != true || vec_a->count != 6)
		return (1);
	else if (ft_vec_at(vec_a, 0) != (void *)42 || ft_vec_at(vec_a, 1) != (void *)43
		|| ft_vec_at(vec_a, 2) != (void *)44 || ft_vec_at(vec_a, 3) != (void *)45
		|| ft_vec_at(vec_a, 4) != (void *)46 || ft_vec_at(vec_a, 5) != (void *)47)
		return (1);
