...
/*   Updated: 2024/05/26 12:18:12 by bgoulard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	test_strtok(void)
{
	...
	strcmp(ft_strtok(NULL, " "), "ipsum") != 0 || \
	strcmp(ft_strtok(NULL, " "), "dolor") != 0)
		return (1);
	if (strcmp(ft_strtok(NULL, " "), "") != 0 || \
	ft_strtok(NULL, " ") != NULL)
		return (2);
	if (strcmp(ft_strtok(test, ":"), "path/to/file") != 0 || \
	strcmp(ft_strtok(NULL, ":"), "another/path") != 0)
		return (3);
	if (strcmp(ft_strtok(NULL, ":/"), "yet") != 0)
		return (4);
